h1. A very basic HTML test page

h2. This is an HTML page to be tested using your own "@reset.css@" style sheet.
...
* "Sample":http://github.com/marcric/basic_html_test_page/blob/master/html_basic_test_result.png
